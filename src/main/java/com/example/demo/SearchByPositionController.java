...
public class SearchByPositionController {
    ...
    public void searchByPosition() {
        ...
        String pos = playerPositionField.getText().trim();
        List<player> players = collection.searchByPosition(pos);

        VBox contentBox = new VBox(10);
        contentBox.setPadding(new Insets(10));

        if (players == null || players.isEmpty()) {
            TextArea textArea = new TextArea("No players available for this position.");
