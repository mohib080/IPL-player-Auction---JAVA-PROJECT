...
public class SearchByCountryClubController {
    ...
    @FXML
    public void searchByCountryClub() {
        if (collection == null) {
            playerDetailsArea.setText("Error: Player collection not initialized.");
            return;
        }

        String country = playerCountryField.getText().trim();
        ...
        if (players == null || players.isEmpty()) {
            TextArea textArea = new TextArea("No players found for this country and club.");
